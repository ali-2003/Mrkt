              ...
              <div className="text-center py-5">
                ...
                {!order && (
                  <div className="alert alert-warning">
                    ...
                    We couldn't find the order details, but your payment was successful. Please contact support with order ID: {orderId}
                  </div>
                )}
                ...
                <div className="mt-4">
                  <Link href="/" className="btn btn-primary mr-3">
                    Continue Shopping
                  </Link>
                  <Link href="/keranjang" className="btn btn-outline-secondary">
                    View Cart
                  </Link>
                </div>
              </div>
